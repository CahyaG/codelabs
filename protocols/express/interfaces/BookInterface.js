...
module.exports = function (TOOLS, MODULES, CONSTANTS) {
    ...
    const bookController = TOOLS.CONTROLLERS.BookController;
    const model = "book";
    return {
        getListWithAuthor: function(previousData, req, res, next){
            let params = {
            ...
            bookController.getListWithAuthor(params, next)
        },
        ...
        getOne: function (previousData, req, res, next) {
            ...
            bookController.getOneWithAuthor(id, next)
        },
